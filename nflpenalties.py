...
st.text("Article: https://medium.com/@ahlon.aj.peoples/exploratory-data-analysis-in-streamlit-how-penalties-impact-teams-and-games-in-the-nfl-f0c8791db96a", unsafe_allow_html=True)
...
with tab_yearspan:
  ...
  team_pen = team_pen.loc[team_pen['penalty_team'] == team_fun_filt]
...
with tab_player:
  ...
  pen_person = pen_person.loc[(pen_person['season'] == year_filt) & (pen_person['penalty_team'] == team_fun_filt)]
...
with tab_types:
  ...
  pen_type = pen_type.loc[(pen_type['season'] == year_filt) & (pen_type['penalty_team'] == team_fun_filt)]
