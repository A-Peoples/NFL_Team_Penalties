...
Original file is located at
    https://colab.research.google.com/drive/1X088NZ_z-418ddcR4FKOO8amn-prZ1yq
"""
...
@st.cache_data()
def load_data():
  pbp = sdv.nfl.load_nfl_pbp((range(2016, 2024+1)), return_as_pandas=True)
  roster = sdv.nfl.load_nfl_rosters(range(2016, 2024+1), return_as_pandas=True)
  return pbp, roster
